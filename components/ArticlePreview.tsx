...
export default function ArticlePreview({ article }: { article: Article }) {
  return (
    <div className="flex flex-col gap-3 mini-card max-h-[160px] cursor-pointer justify-between hover:shadow-lg group">
      <div className="flex flex-col gap-3 ">
        <div className="flex flex-row items-center justify-between flex-nowrap">
          <div className="group-hover:text-blue-400 text-ellipsis whitespace-nowrap overflow-hidden max-w-[calc(100%-40px)]">{article.title}</div>
